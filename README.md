...
Canvas Stocks Server Documentation


Introduction: 

This is ready api backend for Canvas Stocks admin and frontend built with node.js, express, mongoose, and mongodb for database. 
...
For getting started with the template you have to follow the below procedure. First navigate to the canvas-stocks-server directory.
